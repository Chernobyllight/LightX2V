...
usage() {
    cat <<'EOF'
Usage: run_hunyuan_image3_t2i_tp4_cfg1_serial_flashinfer_benchmark.sh [options]
...
benchmark_name="hunyuan_image3_t2i_tp4_cfg1_serial_gpu4_flashinfer_benchmark"
...
"${TORCHRUN_BIN}" --standalone --nproc_per_node=4 -m lightx2v.infer \
    ...
    --config_json "${lightx2v_path}/configs/hunyuan_image3/hunyuan_image3_t2i_tp4_cfg1_serial_flashinfer.json" \
