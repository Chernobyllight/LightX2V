...
usage() {
    cat <<'EOF'
Usage: run_hunyuan_image3_ti2i_ar_tp4_denoise_tp2_sp2_multi_micro_flashinfer_benchmark.sh [options]
...
benchmark_name="hunyuan_image3_ti2i_ar_tp4_denoise_tp2_sp2_cfg1_serial_gpu4_multi_micro_flashinfer_benchmark"
